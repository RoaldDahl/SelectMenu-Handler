...
module.exports = {
  name: "interactionCreate",
    ...
    if (selectMenu.developer && interaction.user.id !== "611115652471717906") return interaction.reply({ embeds: [ new EmbedBuilder().setDescription( `⛔ | This select menu is for developers only.`).setColor("#f8312f") ], ephemeral: true });
